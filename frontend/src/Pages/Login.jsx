...
navigate("/home")
  ...
  return (
    <div className="flex flex-col bg-[url(https://personalmarketingdigital.com.br/wp-content/uploads/2018/05/background-whatsapp-7-1536x960.jpg)] bg-cover bg-center h-screen">
